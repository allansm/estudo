...
public class ConCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<legend style=''>Resultado</legend>");*/
            ...
            try{
                ...
                String hr = "";
                for(Cliente c:lista){
                    if(c.getNome().equals(request.getParameter("nome"))){
            ...
            String msg = "";
            if(mc == 0)msg = "Nenhum resultado encontrado";
            response.setHeader("msg", msg);
            response.setHeader("result", result);
            request.getRequestDispatcher("ResConCliente.jsp").forward(request, response);
