    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                Cliente c = new ClienteDao().consultar((int)session.getAttribute("id"));
                ...
                getServletContext().getRequestDispatcher("/index.jsp?p=FrmClienteConfig.jsp").forward(request, response);
